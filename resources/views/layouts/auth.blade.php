...
<body class="font-sans antialiased">
    ...
    <div class="relative">
        ...
        <!-- DIVISIÓN EN LA PARTE DE ARRIBA CON LOGO Y TEXTO CENTRADOS -->

            <div
                class="hidden md:flex  justify-center items-center 
             bg-gradient-to-r from-{{ $primaryColor }}-500 to-{{ $secondaryColor }}-500 ">

                <div class="text-center text-white space-y-3 p-8 {{'left-0'}}">
                    <a href="{{ route('home') }}" class="inline-flex">
                        <x-icon class="w-28 h-28 mx-auto"/>
                    </a>

                    {{-- Side Description --}}
                    <h2 class="text-4xl font-extrabold text-white">Sistema de control para el manejo de Contratos</h2>
                </div>
            </div>


        {{-- Auth Form --}}
         <div class="absolute flex w-full min-h-screen items-center justify-center py-16
